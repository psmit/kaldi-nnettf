// nnettf/nnettf-get-protoegs.cc
// This file has been adapted from kaldi/src/nnet3bin/nnet3-get-egs.cc

// Copyright 2016 Aalto University (author: Peter Smit)
...
//    example_writer->Write(key, eg);
    eg.addFeature("key", key);
    example_writer->Write(eg);
  }
}
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Get frame-by-frame examples of data for nnettf neural network training.\n"
            ...
            "general)\n"
            "\n"
            "Usage:  nnettf-get-protoegs [options] <features-rspecifier> "
            "<pdf-post-rspecifier> <egs-out>\n"
            "\n"
            "An example [where $feats expands to the actual features]:\n"
            "nnettf-get-protoegs --num-pdfs=2658 --left-context=12 --right-context=9 --num-frames=8 \"$feats\"\\\n"
    ...
    NnetTfProtoWriter example_writer(examples_wspecifier);
